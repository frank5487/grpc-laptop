...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=frank5487.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x37, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xb1, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x66, 0x72, 0x61, 0x6e, 0x6b, 0x35,
	0x34, 0x38, 0x37, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: frank5487.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: frank5487.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: frank5487.pcbook.Memory.unit:type_name -> frank5487.pcbook.Memory.Unit
