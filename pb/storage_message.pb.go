...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=frank5487.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x66, 0x72, 0x61, 0x6e, 0x6b, 0x35, 0x34,
	0x38, 0x37, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x72, 0x69, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x66, 0x72,
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x66, 0x72, 0x61, 0x6e, 0x6b, 0x35, 0x34, 0x38,
	0x37, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: frank5487.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: frank5487.pcbook.Storage
	(*Memory)(nil),      // 2: frank5487.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: frank5487.pcbook.Storage.driver:type_name -> frank5487.pcbook.Storage.Driver
	2, // 1: frank5487.pcbook.Storage.memory:type_name -> frank5487.pcbook.Memory
